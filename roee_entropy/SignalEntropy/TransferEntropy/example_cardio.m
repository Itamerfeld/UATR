%% test cTE on cardiovascular time series
% a single subject example from L Faes, G Nollo, A Porta: 'Information domain approach to the investigation of cardio-vascular, cardio-pulmonary and vasculo-pulmonary causal couplings', Front Physiol, Special Issue “Engineering Approaches to Study Cardiovascular Physiology: Modeling, Estimation, and Signal Processing”, 2011; 2:80.
...
%% Load data
nomefile='tilt.prn'; % either rest.prn or tilt.prn

data=load(nomefile);
Y=data(:,[3 2 1]); % per cardiovascolare, riarrangio per effetti immediati
%col 1: Resp; col 2: SAP; col 3: RR;
[N,M]=size(Y);
